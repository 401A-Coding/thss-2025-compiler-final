...
private:
    ...
    std::string irBuffer;                // 核心：存储拼接后的IR字符串
    std::vector<std::string> currentBBs; // 当前函数的基本块列表
